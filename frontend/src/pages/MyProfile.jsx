                ...
                <div className={"grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700"}>
                    ...
                    {isEdit
                        ? <p>
                            ...
                            }))} value={userData.address.line2}/></p>
            ...
            <div className={"mt-10"}>
                {isEdit
                    ? <button onClick={updateUserProfileData}
                              className={"border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all"}>Save
                        information</button>
                    : <button onClick={() => setIsEdit(true)}
                              className={"border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all"}>Edit</button>
                }
            </div>
        </div>
    )
